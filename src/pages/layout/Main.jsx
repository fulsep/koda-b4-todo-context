...
const Modal = () => {
  ...
  const handleData = (e) => {
    ...
    todoCtx.setData([...todoCtx.data, { title, body, time }]);
    toggleModal();
  };
  const toggleModal = () => {
  ...
  return (
    <div className="absolute top-0 left-0 max-w-md w-full h-screen bg-black/50 flex justify-center items-center">
      <div
        ref={animatedDiv}
        className="w-full mx-10 transition-all duration-500 -translate-y-50 bg-white p-5 py-5 rounded flex flex-col gap-3"
      >
